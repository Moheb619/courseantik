  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user && !user.email_confirmed_at) {
        // User is not verified, show warning and redirect to verification
        toast.error(
          "Your email is not verified. Please check your email and click the verification link to complete your registration."
        );
